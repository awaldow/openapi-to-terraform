...
namespace openapi_to_terraform.Generator.VariablesAppliers
{
    public class ApiVariablesApplier
    {
        public static string ApplyVariables(string generatedOutput, string variablesPath)
        {
            ...
            var apiVersionSetId = terraformVariables.SelectToken("api_managment_version_set_id").Value<string>();
            ...
            outputVariablesApplied = outputVariablesApplied.Replace("{api_managment_version_set_id}", apiVersionSetId);
